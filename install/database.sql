...
CREATE TABLE `media` (
  ...
  `mainthumb` int(2) NOT NULL default '1',
  PRIMARY KEY  (`id`),
...
CREATE TABLE `member` (
  ...
  `friendmail_privacy` int(1) default '1',
